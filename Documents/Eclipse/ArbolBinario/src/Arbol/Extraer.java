...
private void texto(String cadena){
	try{
	String[]t=cadena.split("//");//separacion entre el arbol y texto
	this.Mensaje=t[1];			//parte del Mensaje
	this.Arbol=t[0];			//parte de Arbol
	//System.out.println(Arbol+"||"+Mensaje);		//cadena completa
 ...
 * @param i
 */
public void leer(NodoBinario<T> raiz,int i){
	try{
...
public void preOrden(NodoBinario<T> raiz){
  ...
  public static void main(String [] args){
	...
	e.texto("000-L001-O01-A100-H101-.111- //1000010000111110000100001");
  }
}